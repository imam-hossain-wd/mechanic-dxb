        ...
        <>
            ...
            >
                ...
                <button
                    ...
                    className={cn(
                        "relative flex h-14 w-14 items-center justify-center rounded-full shadow-2xl transition-all duration-300 hover:scale-105",
                        isExpanded
                ...
                {/* Tooltip */}
                {!isExpanded && (
                    <div className="absolute -top-12 right-0 whitespace-nowrap rounded-lg bg-card/90 px-3 py-1.5 text-xs font-medium text-foreground shadow-lg backdrop-blur-sm border border-border/50">
                        Need help?
            ...
            <div className="fixed bottom-0 left-0 right-0 z-40 border-t border-border/50  md:hidden">
                <div className="flex gap-3 items-center justify-around py-2.5 px-4">
                    <Link
                        href={numberCallLink}
                    >
                        <Button className="flex  flex-1 items-center justify-center gap-2 rounded bg-primary py-2.5 shadow-lg shadow-primary/20 transition-all active:scale-95">
                    ...
                    <Link
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex flex-1 items-center justify-center gap-2 rounded bg-[#25D366] py-2.5 shadow-lg shadow-[#25D366]/20 transition-all active:scale-95"
                    >
                        <MessageCircle className="h-4 w-4 text-white" />
